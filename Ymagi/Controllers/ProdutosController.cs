...
namespace Ymagi.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Produto.Include(p => p.Fornecedor).Include(p => p.Membro).Include(p => p.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Unidade,Quantidade,ValorUnit,ValorTotal,Date,UsuarioId,MembroId,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Unidade,Quantidade,ValorUnit,ValorTotal,Date,UsuarioId,MembroId,FornecedorId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
